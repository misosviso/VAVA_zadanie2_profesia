...
public final class SpecialistsView extends javax.swing.JFrame implements DarkNimbus{
     ...
     * WARNING: Do NOT modify this code. The content of this method 5is always
    ...
    private void hireBtnMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_hireBtnMouseReleased
        ...
        if (specialistIndex < 0) {
            ...
            try {
                this.controller.startHireSpecialist(this, specialistIndex);
            } catch (SpecialistAlreadyHiredException ex) {
                JOptionPane.showMessageDialog(rootPane, "Tento freelancer momentálne nie je voľný");
            }
        }
